...
sed -i "/^ROOT_URL=*/c$root_replacement" steedos-projects/project-community/.env.local

# replace METADATA_SERVER
meta_replacement="METADATA_SERVER=$(gp url 5000)"
sed -i "/^METADATA_SERVER=*/c$meta_replacement" steedos-projects/project-community/.env.local
