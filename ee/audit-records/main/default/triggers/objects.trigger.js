 ...
 * @LastEditTime: 2022-06-23 16:33:44
 * @Description: 
 */
...
async function checkIsEnterprise(triggerContext) {
    ...
    if (doc.enable_audit) {
        ...
        const allow = await objectql.getSteedosSchema().broker.call(`@steedos/service-package-license.hasProduct`, { key: 'platform-enterprise', spaceId })
        if (!allow) {
