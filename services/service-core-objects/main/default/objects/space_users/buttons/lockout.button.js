 ...
 * @LastEditTime: 2025-02-19 14:41:45
 * @Description: 
 */
module.exports = {
    lockout: function (object_name, record_id) {
        ...
        swal({
            ...
            if (confirm) {
                ...
                var result = Steedos.authRequest("/service/api/space_users/lockout", {
    ...
    lockoutVisible: function (object_name, record_id, record_permissions, data) {
