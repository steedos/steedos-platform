                ...
                if(objectApiName){
                    ...
                    switch(type){
                        case "form":
                            ...
                            break;
                        case "list":
                            schema = await AmisLib.getListPageInitSchema(objectApiName, formFactor, userSession);
                            return schema;
                        case "record":
                            schema = await AmisLib.getRecordPageInitSchema(objectApiName, {recordId: '${recordId}'});
                            return schema;
                    }
