 ...
 * @LastEditTime: 2022-12-03 17:30:35
 * @Description: 
 */
"use strict";
...
module.exports = {
	...
	actions: {
		...
		register_tenant: {
			...
			async handler(ctx) {
				this.broker.logger.warn('[service][spaces]===>', '/service/api/spaces/register_tenant', ctx.params.name)
		...
		addSpaceUsers: {
			async handler(ctx) {
				this.broker.logger.warn('[service][spaces]===>', 'addSpaceUsers', ctx.params)
