...
if (_.isEmpty(process.env.STEEDOS_WIDGETS_VERSION)) {
  process.env.STEEDOS_WIDGETS_VERSION = "v6.10.1-beta.11";
}
...
process.env.B6_STORAGE_DIR =
  process.env.B6_STORAGE_DIR ||
  process.env.STEEDOS_STORAGE_DIR ||
  path.join(process.cwd(), "steedos-storage");

process.env.B6_LOG_LEVEL =
  process.env.B6_LOG_LEVEL || process.env.STEEDOS_LOG_LEVEL || "warn";
