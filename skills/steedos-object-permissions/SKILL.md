...
description: |
  Multi-level permission control: object-level, field-level, record-level.
  ...
  SKIP: button visibility (visibleOn) → steedos-object-buttons;
  field visible_on → steedos-object-fields; tab permissions → steedos-tabs.
---
