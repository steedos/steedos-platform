...
华炎魔方DX是一套 Visual Studio Code 插件，使您在熟悉的环境中开发、调试、打包、发布华炎魔方应用程序。华炎魔方DX能够将您在可视化界面上定义的元数据导出为配置文件，定义数据导入文件，并轻松指定开发，测试和生产环境的版本，功能和配置参数。您可以充分利用Git提供的版本管理与协作功能管理您的的代码、元数据和配置参数。
