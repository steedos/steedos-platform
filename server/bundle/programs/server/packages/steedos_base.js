...
JsonRoutes.add("get", "/api/bootstrap/:spaceId/", function (req, res, next) {
  var _Apps, _Dashboards, authToken, lng, permissions, ref, result, space, spaceId, userId, userSession;
