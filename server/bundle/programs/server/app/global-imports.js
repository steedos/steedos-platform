...
steedosRequest = Package['steedos:qhd-archive-sync'].steedosRequest;
InstancesToArchive = Package['steedos:qhd-archive-sync'].InstancesToArchive;
InstancesToContracts = Package['steedos:qhd-archive-sync'].InstancesToContracts;
InstanceManager = Package['steedos:qhd-archive-sync'].InstanceManager;
RecordsQHD = Package['steedos:qhd-archive-sync'].RecordsQHD;
XMLSync = Package['steedos:qhd-archive-xml'].XMLSync;
ExportToXML = Package['steedos:qhd-archive-xml'].ExportToXML;
WebhookQueue = Package['steedos:webhookqueue'].WebhookQueue;
uuflowManager = Package['steedos:app-workflow'].uuflowManager;
permissionManager = Package['steedos:creator'].permissionManager;
