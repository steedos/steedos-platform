...
function formatBasicFieldValue(valueType, field, value, objectConfig, userSession) {
    switch (valueType) {
        ...
        case 'html':
            return value || "";
        case 'boolean':
            return value ? "<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' class='w-6 h-6'><path stroke-linecap='round' stroke-linejoin='round' d='M4.5 12.75l6 6 9-13.5' /></svg>" : ""
        case 'date':
