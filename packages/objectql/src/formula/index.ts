...
async function _computeFormula(formula: string, objectName:string, record: JsonMap, userSession: any, spaceId: string, options?: SteedosFormulaOptions)
async function _computeFormula(formula: string, objectName:string, recordId: string, userSession: any, spaceId: string, options?: SteedosFormulaOptions)
async function _computeFormula(formula: string, objectName:string, data: any, userSession: any, spaceId: string, options?: SteedosFormulaOptions) {
...
async function _computeSimpleFormula(formula: string, data: any, userSession?: any, spaceId?: string, options?: SteedosFormulaOptions) {
