...
async function CliLogic(lng, packageDir) {
...
function sortAttribute(obj, debug = false) {
...
async function updateObjectsI18n(lng, packageDir, configs, content) {
    ...
    _.each(configs, function (config) {
        ...
        if (filename && filename.indexOf("node_modules") < 0) {
            ...
            if (!metadata_core_1.mkdirsSync(ranslationsFolder)) {
            ...
            if (!metadata_core_1.mkdirsSync(fileFolder)) {
