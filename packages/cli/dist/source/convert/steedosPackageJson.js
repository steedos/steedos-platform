...
exports.scanTargetDir = void 0;
const fs = require('fs');
const os = require('os');
const path = require("path");
const chalk = require('chalk');
const yaml = require('js-yaml');
function scanTargetDir(tarDir) {
    // var index = 0;
...
exports.scanTargetDir = scanTargetDir;
/**
 *
 * @param des
 ...
 */
function scanOrAdd(des, filePath, is_recursion) {
...
//# sourceMappingURL=steedosPackageJson.js.map