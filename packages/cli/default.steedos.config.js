...
if(_.isEmpty(process.env.STEEDOS_AMIS_VERSION)) {
	process.env.STEEDOS_AMIS_VERSION = '3.6.3-patch.5';
}
...
if(_.isEmpty(process.env.STEEDOS_PUBLIC_PAGE_ASSETURLS)) {
	process.env.STEEDOS_PUBLIC_PAGE_ASSETURLS = process.env.STEEDOS_UNPKG_URL + "/@steedos-widgets/amis-object@3.6.2-beta.12/dist/assets.json";
}
