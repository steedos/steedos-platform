  ...
  render() {
    ...
    Object.keys(this.props.spaces).forEach((spaceId) => {
      ...
      <a
        ...
        class="w-full text-left border-b border-gray-100 block hover:bg-blue-100 focus:outline-none transition duration-150 ease-in-out">
        <div class="flex items-center px-10 py-4">
          <div class="min-w-0 flex-1 flex items-center">
            <div class="flex-shrink-0 pr-4 text-gray-600">
            ...
            <div class="min-w-0 flex-1">
              <div>
                <div class="text-lg leading-5 font-medium truncate">{space.name}</div>                
              </div>
            </div>
          </div>
          <div>
