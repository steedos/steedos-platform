...
If you want to customize the appearance of the input, for example to use an input group with date/time icons, use the [aldeed:template-extension](https://atmospherejs.com/aldeed/template-extension) package to replace the "dxDateBox" template, like this:
...
```js
Template.dpReplacement.replaces("dxDateBox");
```
