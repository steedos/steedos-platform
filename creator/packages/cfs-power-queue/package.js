...
Package.onUse(function (api) {
  ...
  api.use(['deps', 'steedos:cfs-reactive-property'], ['client', 'server']);
  ...
  api.use(['steedos:cfs-reactive-list', 'steedos:cfs-micro-queue'], ['client', 'server'], { weak: true });
...
Package.onTest(function (api) {
  api.use(['steedos:cfs-power-queue', 'steedos:cfs-reactive-list']);
