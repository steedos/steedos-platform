...
Package.onUse(function(api) {
	...
	api.addFiles('client/coreform/inputTypes/boolean-toggle/boolean-toggle.html', 'client');
	api.addFiles('client/coreform/inputTypes/boolean-toggle/boolean-toggle.js', 'client');
