var BuilderReact = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function validateChanges(initial, changes) {
      if (!isObject$1(changes)) errorHandler('changeType');
    ...
    function validateSelector(selector) {
      if (!isFunction$1(selector)) errorHandler('selectorType');
    }
  
    function validateHandler(handler) {
      if (!(isFunction$1(handler) || isObject$1(handler))) errorHandler('handlerType');
    ...
    function validateInitial(initial) {
      ...
      if (!isObject$1(initial)) errorHandler('initialType');
    ...
    function validateConfig(config) {
      ...
      if (!isObject$2(config)) errorHandler$1('configType');
    ...
    var SteedosBuilder=function(e){function r(){return null!==e&&e.apply(this,arguments)||this}return __extends(r,e),r.require=function(e,t){if(Builder.isBrowser)return r.requirejs(e,t);console.warn("Builder.require used on the server - this should only be used in the browser");},r.registerImportMap=function(e){if(Builder.isBrowser){Object.assign(this.importMap,e);var t={type:"builder.importMapChange",data:this.importMap};return parent.postMessage(t,"*"),r.requirejs.config({paths:this.importMap})}},r.injectCSS=function(e,r){var t=(void 0===r?{}:r).insertAt,n=void 0===t?"top":t;if(e&&"undefined"!=typeof document){var s=document.head||document.getElementsByTagName("head")[0],i=document.createElement("link");i.type="text/css",i.rel="stylesheet",i.href=e,"top"===n&&s.firstChild?s.insertBefore(i,s.firstChild):s.appendChild(i);}},Object.defineProperty(r.prototype,"host",{get:function(){switch(this.env){case"development":case"dev":return "http://localhost:5000";default:return Builder.overrideHost||"https://console.steedos.cn"}},enumerable:!1,configurable:!0}),r.settings={unpkgUrl:"https://unpkg.com"},r.importMap={},r.packages={},r.stores={},r.requirejs=require_3,r.define=require_2,r.requirejsPromise=function(e){return __awaiter(void 0,void 0,void 0,function(){return __generator(this,function(t){switch(t.label){case 0:return [4,new Promise(function(t,n){try{r.requirejs(e,function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];t(e);});}catch(e){n(e);}})];case 1:return [2,t.sent()]}})})},r.registerRemoteAssets=function(e,t){var n,s;return __awaiter(void 0,void 0,void 0,function(){var i,o,u,a,d,l;return __generator(this,function(c){switch(c.label){case 0:if(!Builder.isBrowser)return console.warn("Builder.require used on the server - this should only be used in the browser"),[2];"string"==typeof e&&(e=[e]),c.label=1;case 1:c.trys.push([1,9,10,15]),n=__asyncValues(e),c.label=2;case 2:return [4,n.next()];case 3:return (s=c.sent()).done?[3,8]:(i=s.value,o=i.replace("https://unpkg.com",r.settings.unpkgUrl),[4,fetch(o)]);case 4:return [4,c.sent().json()];case 5:return u=c.sent(),[4,r.registerAssets(u,t)];case 6:c.sent(),c.label=7;case 7:return [3,2];case 8:return [3,15];case 9:return a=c.sent(),d={error:a},[3,15];case 10:return c.trys.push([10,,13,14]),s&&!s.done&&(l=n.return)?[4,l.call(n)]:[3,12];case 11:c.sent(),c.label=12;case 12:return [3,14];case 13:if(d)throw d.error;return [7];case 14:return [7];case 15:return Builder.register("remote-assets",{assetUrls:e}),[2]}})})},r.registerAssets=function(e,t){return __awaiter(void 0,void 0,void 0,function(){var n,s,i,o,u,a,d,l,c,p,m,h;return __generator(this,function(f){switch(f.label){case 0:return n=e.packages,s=e.components,Builder.isBrowser?(Builder.register("assets",{assets:e}),i=[],o=[],u={},null===n||void 0===n||n.forEach(function(e,t){return __awaiter(void 0,void 0,void 0,function(){var t,n;return __generator(this,function(s){return e.urls&&Array.isArray(e.urls)&&e.urls.length>0&&e.package&&e.library&&(t=e.urls[0],n=e.urls[1],(null===t||void 0===t?void 0:t.endsWith(".js"))&&(t=(t=t.replace("https://unpkg.com",r.settings.unpkgUrl)).substring(0,t.length-3),u[e.package]=t,i.push(e.package),o.push(e.library),r.packages[e.package]=e),(null===n||void 0===n?void 0:n.endsWith(".css"))&&(n=n.replace("https://unpkg.com",r.settings.unpkgUrl),r.injectCSS(n))),[2]})})}),r.registerImportMap(u),[4,r.requirejsPromise(i)]):(console.warn("Builder.require used on the server - this should only be used in the browser"),[2]);case 1:if(f.sent(),!s)return [3,14];f.label=2;case 2:f.trys.push([2,8,9,14]),a=__asyncValues(s),f.label=3;case 3:return [4,a.next()];case 4:return (d=f.sent()).done?[3,7]:(l=d.value).url?(c=l.url.replace("https://unpkg.com",r.settings.unpkgUrl),[4,r.requirejsPromise([c])]):[3,6];case 5:f.sent(),l.exportName&&void 0!==window[l.exportName]&&r.registerMeta(window[l.exportName]),f.label=6;case 6:return [3,3];case 7:return [3,14];case 8:return p=f.sent(),m={error:p},[3,14];case 9:return f.trys.push([9,,12,13]),d&&!d.done&&(h=a.return)?[4,h.call(a)]:[3,11];case 10:f.sent(),f.label=11;case 11:return [3,13];case 12:if(m)throw m.error;return [7];case 13:return [7];case 14:return t&&t(),[2]}})})},r.registerMeta=function(e){Builder.register("metas",{meta:e}),e.components&&e.components.forEach(function(e,t){return __awaiter(void 0,void 0,void 0,function(){var t,n,s,i,o;return __generator(this,function(u){return (null===(s=e.npm)||void 0===s?void 0:s.package)&&(null===(i=e.npm)||void 0===i?void 0:i.exportName)&&(t=null===(o=r.packages[e.npm.package])||void 0===o?void 0:o.library)&&(n=window[t])&&(Builder.registerComponent(n[e.npm.exportName],{name:e.componentName}),Builder.register("meta-components",e)),[2]})})});},r.registerAmis=function(e){var r=e.render,t=e.editor;r&&Builder.registerComponent("AmisRender",r),t&&Builder.registerComponent("AmisEditor",t);},r.initMonaco=function(){return __awaiter(void 0,void 0,void 0,function(){return __generator(this,function(e){return loader.config({paths:{vs:r.settings.unpkgUrl+"/monaco-editor/min/vs"}}),loader.init().then(function(e){window.MonacoEnvironment=void 0,"function"==typeof window.define&&window.define.amd&&delete window.define.amd,window.monaco=e;}),[2]})})},r}(Builder),builder$1=new SteedosBuilder(null,void 0,void 0,!0);SteedosBuilder.singletonInstance=builder$1;var stores={};SteedosBuilder.stores=stores;
